...
public class SignupTwo extends JFrame implements ActionListener{
    ...
    SignupTwo(String formno) {
        ...
        String educationValues[] = {"Salaried","Self-Employed","Business","Student","Retired","Others"};
        ...
        String occupationValues[] = {"UnderGraduate","Graduate","Post-Graduate","Doctrate","Others"};
